...
\begin{multicols}{3}
    %\null \vfill
    \name{Oswin Jonathan}{Rodrigues}\par
    \vfill \null
\columnbreak
    %\null \vfill
    \program{\textbf{3A Mechatronics Engineering}}\par
    \focus{Hardware}{Embedded}\par
...
\datedsubsection{\textbf{AI \& Robotics Engineer Intern}}{Winter 2016}
...
\datedsubsection{\textbf{UW Robotics Team \& Waterloo Autonomous Vehicles Lab}}{Ongoing}%{\faCar}
\begin{itemize}
